...
.nav-count{margin-left:auto;min-width:20px;height:20px;padding:0 5px;border-radius:999px;background:#b5c019;color:#171817;display:inline-grid;place-items:center;font-size:10px;font-style:normal;font-weight:900}
