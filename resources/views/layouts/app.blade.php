...
.customer-notification-link{gap:8px!important}.customer-notification-link svg{width:18px;height:18px;flex:0 0 18px;fill:none;stroke:currentColor;stroke-width:2;stroke-linecap:round;stroke-linejoin:round}.customer-notification-link>b{min-width:20px;height:20px;margin-left:auto;padding:0 6px;border-radius:999px;background:#b5c019;color:#171817;display:inline-flex;align-items:center;justify-content:center;font-size:11px;line-height:1}.booking-nav .customer-notification-link>b{margin-left:auto}@media(max-width:520px){.customer-notification-link svg{display:none}.customer-notification-link>b{min-width:17px;height:17px;padding:0 4px;font-size:10px}}
