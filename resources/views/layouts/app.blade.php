...
:root { color-scheme: light; font-family: Inter, ui-sans-serif, system-ui, sans-serif; }
        * { box-sizing: border-box; }
        ...
        form[data-ajax-form][aria-busy="true"]{opacity:.72;pointer-events:none}.ajax-form-inline-error{margin:0 0 14px;padding:11px 13px;border:1px solid #efc8c5;border-radius:9px;background:#fff0f0;color:#a51d16;font-size:13px}.ajax-form-toast{position:fixed;z-index:2000;top:20px;right:20px;max-width:min(390px,calc(100vw - 32px));padding:13px 16px;border:1px solid #b8dbc4;border-radius:11px;background:#edf8f0;color:#267444;font-size:14px;font-weight:650;box-shadow:0 14px 34px rgba(23,24,23,.18);transition:opacity .2s,transform .2s}.ajax-form-toast.is-error{border-color:#efc8c5;background:#fff0f0;color:#a51d16}.ajax-form-toast.is-hiding{opacity:0;transform:translateY(-8px)}
