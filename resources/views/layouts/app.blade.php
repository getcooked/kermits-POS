...
:root { color-scheme: light; font-family: Inter, ui-sans-serif, system-ui, sans-serif; }
        * { box-sizing: border-box; }
        ...
        form[data-ajax-form][aria-busy="true"]{opacity:.72;pointer-events:none}.ajax-form-inline-error{margin:0 0 14px;padding:11px 13px;border:1px solid #efc8c5;border-radius:9px;background:#fff0f0;color:#a51d16;font-size:13px}
        .ajax-form-toast{position:fixed;z-index:2000;top:20px;right:20px;width:min(410px,calc(100vw - 32px));min-height:76px;display:grid;grid-template-columns:40px minmax(0,1fr) 28px;align-items:center;gap:12px;padding:14px 14px 16px;border:1px solid #cdd59c;border-radius:14px;overflow:hidden;background:#fffef8;color:#171817;box-shadow:0 18px 48px rgba(23,24,23,.22);animation:ajax-toast-in .28s cubic-bezier(.22,.72,.18,1);transition:opacity .2s,transform .2s}.ajax-form-toast-icon{width:40px;height:40px;display:grid;place-items:center;border-radius:50%;background:#e9efc8;color:#596300;font-size:20px;font-weight:900}.ajax-form-toast-copy{min-width:0;display:grid;gap:3px;font-size:13px;line-height:1.4;color:#596056}.ajax-form-toast-copy strong{color:#171817;font-size:14px}.ajax-form-toast-close{width:28px;height:28px;align-self:start;display:grid;place-items:center;padding:0;border:0;border-radius:8px;background:transparent;color:#777d72;font-size:22px;line-height:1;cursor:pointer}.ajax-form-toast-close:hover{background:#f0f1e8;color:#171817}.ajax-form-toast-progress{position:absolute;right:0;bottom:0;left:0;height:3px;background:#aebb19;transform-origin:left;animation:ajax-toast-progress 5s linear forwards}.ajax-form-toast.is-error{border-color:#efc8c5;background:#fffafa}.ajax-form-toast.is-error .ajax-form-toast-icon{background:#fff0f0;color:#a51d16}.ajax-form-toast.is-error .ajax-form-toast-progress{background:#c42b2b}.ajax-form-toast.is-hiding{opacity:0;transform:translateY(-8px)}@keyframes ajax-toast-in{from{opacity:0;transform:translateY(-10px)}to{opacity:1;transform:translateY(0)}}@keyframes ajax-toast-progress{from{transform:scaleX(1)}to{transform:scaleX(0)}}@media(max-width:520px){.ajax-form-toast{top:12px;right:16px;left:16px;width:auto}}@media(prefers-reduced-motion:reduce){.ajax-form-toast,.ajax-form-toast-progress{animation:none}}
        .app-alert-layer{position:fixed;z-index:4000;inset:0;display:grid;place-items:center;padding:20px;background:rgba(16,18,15,.56);backdrop-filter:blur(5px);animation:app-alert-layer-in .2s ease;transition:opacity .2s ease}.app-alert-layer .ajax-form-toast{position:relative;top:auto;right:auto;width:min(440px,100%);min-height:0;display:flex;flex-direction:column;align-items:center;gap:0;padding:32px 30px 26px;border:1px solid #d8ddbd;border-radius:22px;overflow:hidden;background:#fffef9;color:#171817;text-align:center;box-shadow:0 28px 80px rgba(10,12,9,.32);animation:app-alert-dialog-in .3s cubic-bezier(.2,.8,.2,1);transition:opacity .18s ease,transform .18s ease}.app-alert-layer .ajax-form-toast-icon{width:58px;height:58px;display:grid;place-items:center;margin-bottom:17px;border-radius:50%;background:#edf1cf;color:#626c00;font-size:29px;font-weight:900;box-shadow:0 0 0 9px rgba(174,187,25,.1)}.app-alert-layer .ajax-form-toast-copy{display:grid;gap:8px;width:100%;color:#60665d;font-size:14px;line-height:1.55}.app-alert-layer .ajax-form-toast-copy strong{color:#171817;font-size:21px;letter-spacing:-.02em}.app-alert-layer .ajax-form-toast-close{position:absolute;top:12px;right:12px;width:34px;height:34px;display:grid;place-items:center;padding:0;border:0;border-radius:10px;background:transparent;color:#777d72;font-size:24px;line-height:1;cursor:pointer}.app-alert-layer .ajax-form-toast-close:hover{background:#f0f1e8;color:#171817}.app-alert-actions{display:flex;justify-content:center;gap:10px;width:100%;margin-top:23px}.app-alert-button{min-width:112px;min-height:43px;padding:10px 18px;border:1px solid #d3d6cc;border-radius:11px;background:#fff;color:#30342f;font-weight:800;cursor:pointer}.app-alert-button:hover{background:#f2f3ec}.app-alert-button.is-primary{border-color:#171817;background:#171817;color:#fff}.app-alert-button.is-primary:hover{background:#31342f}.app-alert-layer .ajax-form-toast-progress{position:absolute;right:0;bottom:0;left:0;height:4px;background:#aebb19;transform-origin:left;animation:ajax-toast-progress 5s linear forwards}.app-alert-layer .ajax-form-toast.is-error{border-color:#ebceca;background:#fffbfa}.app-alert-layer .ajax-form-toast.is-error .ajax-form-toast-icon{background:#fde9e7;color:#b42318;box-shadow:0 0 0 9px rgba(180,35,24,.08)}.app-alert-layer .ajax-form-toast.is-error .ajax-form-toast-progress{background:#c42b2b}.app-alert-layer .ajax-form-toast.is-confirm .ajax-form-toast-icon{background:#fff1d6;color:#9a5b00;box-shadow:0 0 0 9px rgba(224,146,24,.09)}.app-alert-layer.is-hiding{opacity:0}.app-alert-layer.is-hiding .ajax-form-toast{opacity:0;transform:translateY(8px) scale(.98)}@keyframes app-alert-layer-in{from{opacity:0}to{opacity:1}}@keyframes app-alert-dialog-in{from{opacity:0;transform:translateY(14px) scale(.96)}to{opacity:1;transform:translateY(0) scale(1)}}@media(max-width:520px){.app-alert-layer{padding:16px}.app-alert-layer .ajax-form-toast{width:100%;padding:28px 20px 22px;border-radius:18px}.app-alert-layer .ajax-form-toast-copy strong{font-size:19px}.app-alert-actions{flex-direction:column-reverse}.app-alert-button{width:100%}}@media(prefers-reduced-motion:reduce){.app-alert-layer,.app-alert-layer .ajax-form-toast,.app-alert-layer .ajax-form-toast-progress{animation:none}}
