...
<main class="reset-page">
    ...
    <section class="reset-form"><div class="reset-inner">
        ...
        <p class="muted">Use at least eight characters with both letters and numbers.</p>
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div class="field"><label for="password">New password</label><input class="control" id="password" name="password" type="password" minlength="8" autocomplete="new-password" required>@error('password')<p class="error">{{ $message }}</p>@enderror</div>
            <div class="field"><label for="password_confirmation">Confirm new password</label><input class="control" id="password_confirmation" name="password_confirmation" type="password" minlength="8" autocomplete="new-password" required></div>
