<aside class="admin-sidebar">
    ...
    <nav>
        ...
        @if(auth()->user()->hasRole('super_admin'))<a class="{{ request()->routeIs('superadmin.security.*') ? 'active' : '' }}" href="{{ route('superadmin.security.edit') }}">@include('partials.nav-icon',['name'=>'security']) Security</a>@endif
