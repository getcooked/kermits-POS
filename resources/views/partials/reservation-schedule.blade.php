<div class="reservation-schedule" data-schedule data-url="{{ route('reservations.availability') }}">
    ...
    <p>Availability is checked automatically for your party size. Pending reservations are held for 30 minutes, or until arrival if sooner, while awaiting approval.</p>
