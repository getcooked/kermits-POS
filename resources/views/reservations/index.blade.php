            ...
            @forelse($reservations as $reservation)
                <article class="welcome reservation-card">
                    ...
                    @if($reservation->booking_status === 'pending')
                        <form method="POST" action="{{ route('reservations.status', $reservation) }}">@csrf @method('PATCH')<label>Admin decision</label><select class="control" name="status"><option value="confirmed">Approve reservation</option><option value="rejected">Decline reservation</option></select><button class="button">Save decision</button></form>
