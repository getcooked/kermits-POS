    ...
    <section class="panel">
        ...
        @else
            ...
            <form method="POST" action="{{ route('web-seeder.store') }}">@csrf
                ...
                <div class="field"><label for="password">Account password</label><input id="password" name="password" type="password" minlength="8" maxlength="23" autocomplete="new-password" required><small>Use 8-23 characters with uppercase, lowercase, a number, and a symbol.</small></div>
