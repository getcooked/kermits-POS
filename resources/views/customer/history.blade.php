                    ...
                    <article class="activity-card">
                        <div class="activity-main">
                            ...
                            <dl class="activity-details">
                                ...
                                <div><dt>Party</dt><dd>{{ $reservation->type === 'table' ? $reservation->table_size.' seats' : $reservation->guests.' guests' }}</dd></div>@if($reservation->type === 'table')<div><dt>Table</dt><dd>{{ $reservation->table_label }}</dd></div>@endif
                ...
                @foreach($dateOrders as $order)
                    ...
                    <article class="activity-card purchase-card">
                        <div class="activity-main">
                            <div class="activity-title">
                                <div>
                                    <span class="activity-kind">{{ match($order->payment_method) { 'cash' => 'Walk In Pay', 'paymongo' => 'PayMongo online', default => 'GCash' } }} payment</span>
