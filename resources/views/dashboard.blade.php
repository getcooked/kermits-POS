...
<div class="admin-shell">
    ...
    <main class="admin-workspace">
        <header class="dash-head">
            <div>
                <p>STORE OVERVIEW</p>
                <h1>Hi, here’s what’s happening<br>at Kermit’s</h1>
        ...
        <div class="dash-grid">
            <section class="panel">
                ...
                <div class="sales-list">@forelse($recentOrders as $order)<a href="{{ route('receipts.show',$order) }}"><span class="order-mark">#{{ $order->id }}</span>
                    ...
                    </a>@empty<p class="empty">No sales yet. Open the cashier to record your first transaction.</p>@endforelse</div>
            </section>
            <section class="panel">
                <div class="panel-head">
                    <div>
...
<style>
    ...
    .app-shell {
        ...
        background: #f5f6ef;
        border: 10px solid #181918;
        border-radius: 30px;
        overflow: hidden;
        box-shadow: 0 30px 80px rgba(22, 25, 22, .15)
    }
    ...
    .bars i {
        ...
        flex: 1;
        min-width: 5px;
        background: linear-gradient(#aab514, #e8ecc3);
    ...
    .bars i:hover,
    .bars i:focus {
        background: linear-gradient(#778300, #cdd68c)
    }
