...
@section('content')
@php($reservation = $order->reservation)
<main class="online-receipt-page">
    <div class="online-receipt-wrap">
        <header class="receipt-heading">
            <div><p>ORDER &amp; RESERVATION RECEIVED</p><h1>Thank you, {{ auth()->user()->name }}.</h1></div>
        </header>
        ...
        <article class="online-receipt">
            ...
            <div class="receipt-totals">
                ...
                <div class="receipt-total"><span>Total due</span><strong>&#8369;{{ number_format($order->totalDue(), 2) }}</strong></div>
            </div>
